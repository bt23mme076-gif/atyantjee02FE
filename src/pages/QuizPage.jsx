...
import { ArrowLeft, ArrowRight, RotateCcw, CheckCircle, Loader2, ChevronRight, Mail } from 'lucide-react';
import { getQuizQuestions, submitQuizAnswers, submitQuizEmail } from '../utils/api';
  ...
  return (
    <svg width={size} height={size} className="-rotate-90">
      ...
      <circle
        ...
        stroke="#FF6B2B" strokeWidth={strokeWidth}
...
import {
  Code, Database, Briefcase, Palette, Shield, Cloud, Settings, Zap,
  Building, LineChart, DollarSign, GraduationCap, Award, Globe, Rocket,
  Gamepad2, Megaphone, Coins, Truck, Bot, Brain, Cpu, Link2, PenTool,
  Handshake, Users, Scale, FlaskConical, Leaf, HelpCircle
} from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <span className={`flex-shrink-0 h-5 w-5 rounded-${multiSelect ? 'md' : 'full'} border-2 flex items-center justify-center transition-all ${
...
function ResultCard({ match, rank }) {
  ...
  const rankColors = ['from-[#FF6B2B] to-[#ff8c59]', 'from-[#7c3aed] to-[#9f67fa]', 'from-[#0ea5e9] to-[#38bdf8]'];
  return (
    <Link to={`/careers/${match.careerId}`}>
      ...
      >
        {/* Rank badge */}
        <div className={`absolute top-4 right-4 h-7 w-7 rounded-full bg-gradient-to-br ${rankColors[rank]} flex items-center justify-center text-xs font-black text-white shadow-lg`}>
          {rank + 1}
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          ...
          <div className="relative flex-shrink-0 mt-2 sm:mt-0">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center">
              <span className="text-base font-black text-white leading-none">{match.matchPercent}%</span>
              <span className="text-[9px] text-white/50 leading-none mt-0.5 uppercase tracking-wider">match</span>
            </div>
          </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 mb-2 justify-center sm:justify-start">
              <div className="flex items-center gap-2 justify-center sm:justify-start">
                ...
                <span className="text-base font-bold text-white leading-none">
                  {match.title || match.careerId.replace(/-/g, ' ').replace(/\b\w/g, c => c.toUpperCase())}
                </span>
              </div>
            </div>
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[#0B0F2E] flex flex-col items-center justify-center gap-4 px-4 text-center">
        ...
        <button onClick={() => navigate(-1)} className="text-sm text-[#FF6B2B] underline">Go back</button>
      </div>
    );
  }
            ...
            <div className="lg:col-span-5 space-y-6 text-center lg:text-left">
              <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <p className="mt-3 text-white/60 text-sm sm:text-base leading-relaxed">
                  Based on your answers, here are the 3 paths that fit you best. Explore them to find roadmaps, skills, and senior guidance.
                </p>
              </motion.div>
              ...
              {!emailSent && (
                ...
                >
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <p className="text-sm font-semibold text-white">Get your results in your inbox</p>
                  </div>
              ...
              {emailSent && (
                ...
                >
                  ...
                  <p className="mt-1 text-xs text-white/50">
                    Your results will be sent to {email}
                  </p>
                </motion.div>
              )}
            </div>
    ...
    <div className="min-h-screen bg-[#0B0F2E] px-4 py-16 sm:px-6">
      ...
      <div className="mx-auto max-w-xl">
        ...
        <AnimatePresence mode="wait" initial={false}>
          ...
          >
            <div className="mb-8">
              <h2 className="text-xl font-black text-white sm:text-2xl leading-tight">{currentQ?.question}</h2>
              {currentQ?.subtext && (
