...
const _override = (() => {
  try {
    return JSON.parse(localStorage.getItem('siteContentOverride') || 'null');
  } catch {
    return null;
  }
})();
...
export const heroTrustBadges = _override?.heroTrustBadges ?? [
...
export const painPoints = _override?.painPoints ?? [
  {
    ...
    icon: GraduationCap,
    description:
      'A rank alone does not tell you whether the college, branch, city, or peer group fits your future.',
  },
  {
    title: 'Take wrong branch due to pressure',
    icon: HeartHandshake,
    description:
      'Family pressure, coach advice, and fear can push students into a branch they never wanted.',
  },
  {
    title: 'Lose 4 years fixing wrong decisions',
    icon: Clock3,
    description:
      'A confusing admission choice can turn into a long, expensive detour in college life.',
  },
];
...
export const pillars = [
  {
    title: 'Real Seniors',
    description:
      'Talk to students from the colleges you are considering and hear the reality directly.',
    icon: Users2,
  },
  {
    title: 'Real Placement Truth',
    description:
      'Understand placements, branch reality, culture, opportunities, and what actually happens after joining.',
    icon: ShieldCheck,
  },
  {
  ...
  },
  {
    ...
    description:
      'Make decisions your parents can trust because they are practical, clear, and future-safe.',
    icon: School2,
  },
];
...
export const pricingPlans = _override?.pricingPlans ?? [
  {
    title: 'Complete CSAB Support',
    price: '999',
    originalPrice: '1,999',
    discount: '50% OFF',
    discountLabel: 'Best Choice for Most',
    bestFor: 'Full support throughout the CSAB Special Rounds. Dedicated mentor from registration till final allotment.',
    features: [
      'Complete CSAB Special Round Guidance',
      'Dedicated Mentor',
  ...
  {
    title: 'Ultimate CSAB Mentorship',
    price: '1,599',
    originalPrice: '3,199',
    discount: '50% OFF',
    discountLabel: '1-on-1 Premium',
    bestFor: 'Highest level of personal support with a dedicated mentor.',
    features: [
...
export const testimonials = _override?.testimonials ?? [
  {
    ...
    city: 'Nagpur',
    quote:
      'I had no idea whether to pick CSE at NIT Raipur or ECE at NIT Warangal. One session gave me placement data I could not find anywhere online. Made the right call.',
    stars: 5,
  },
  {
    name: 'Arjun Mehta',
    city: 'Indore',
    quote:
      'My parents were pushing for a big name college over branch. After talking to a senior from BITS Pilani, we completely changed our strategy. Best decision ever.',
    stars: 4,
  },
  {
    name: 'Kavya Reddy',
    city: 'Bhopal',
    quote:
      'I was about to join a private college out of panic. The session showed me I still had good options left in counselling. Saved me 4 years of regret.',
    stars: 5,
  },
  {
    name: 'Rahul Tiwari',
    city: 'Patna',
    quote:
      'Got clarity on which NIT branch actually has placements vs which ones just look good on paper. Nobody else gave me this honest breakdown.',
    stars: 5,
  },
  {
    name: 'Ananya Singh',
    city: 'Lucknow',
    quote:
      'My JEE rank was average and I felt lost. After the session I had a clear list of 6 colleges to target in JOSAA. Got into my first choice.',
    stars: 4,
  },
  {
    name: 'Vikram Joshi',
    city: 'Surat',
    quote:
      'The senior I talked to had the exact same rank as me two years ago. Hearing what worked for them was more useful than any YouTube video I watched.',
    stars: 5,
  },
  {
    name: 'Sneha Kulkarni',
    city: 'Pune',
    quote:
      'I was confused between IIIT Pune and a lower branch in VNIT. The mentorship session helped me compare future opportunities instead of just college tags.',
    stars: 5,
  },
  {
    name: 'Aditya Verma',
    city: 'Kanpur',
    quote:
      'Every counselling video online was giving different advice. Here I finally got a realistic roadmap based on my actual percentile and category.',
    stars: 5,
  },
];
    ...
    items: [
      {
        ...
        answer:
          '1:1 sessions with current NIT/IIT/IIIT students who help you understand JoSAA/CSAB rounds, fill your choice list strategically, decode branch vs. college trade-offs, and avoid the mistakes most aspirants make in the 5-day window.',
      },
      {
        question: 'Is this the same as JoSAA counselling?',
        answer:
          'No. JoSAA is the official allotment process. We help you prepare for it — figuring out which colleges and branches to fill, in what order, based on your rank, category, home state, and goals.',
      },
      {
        question: 'Do you actually fill the JoSAA form for me?',
        answer:
          'No. You fill it yourself on the official JoSAA portal. We help you decide what to fill — the strategy, not the data entry.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          "If you're confident about your top 3 choices, maybe not. If you're staring at 80+ possible college-branch combinations and don't know how to order them, yes. Most aspirants underestimate how much one wrong choice order costs them.",
      },
      {
        question: "I'm in OBC/SC/ST/EWS category. Can you help with category-specific counselling?",
        answer:
          'Yes. Our mentors include students from every category who went through the exact same counselling logic. Filter mentors by category match.',
      },
      {
        question:
          "I'm a girl candidate eligible for female supernumerary seats. Does that change strategy?",
        answer:
          'Yes, significantly. We have mentors who used the female pool to get into better colleges than their rank suggested. Book one before locking your choice list.',
      },
      {
        question:
          'My rank is low. Should I even bother with JoSAA or go straight to private colleges?',
        answer:
          'Talk to a mentor first. Many aspirants give up on JoSAA too early and miss CSAB special rounds where good colleges open up. Others waste weeks on JoSAA when their rank made it impossible from day one.',
      },
    ],
  },
  {
    ...
    items: [
      {
        question:
          'How do I decide between a higher-ranked branch at a lower NIT vs. a lower-ranked branch at a top NIT?',
        answer:
          "This is the single most asked question in JEE counselling. There's no formula. Talk to mentors from both paths — they'll tell you what placements, peer group, and life actually looked like.",
      },
      {
        question: 'Is CSE everywhere worth it, or should I take core branches at better NITs?',
        answer:
          "The honest answer changes every year based on placement trends. Get a current student's view, not a 2019 Quora answer.",
      },
      {
        question:
          "Should I take a branch I don't want just to get into a top NIT, hoping to switch later?",
        answer:
          "Branch change rules vary by college and are getting harder every year. Don't bet on it without talking to someone who tried.",
      },
      {
        question: 'NIT vs. IIIT vs. BITS vs. state government college — how do I compare?',
        answer:
          'Each has different placement realities, fee structures, and campus life. We have mentors from all four — book whichever combination matches your shortlist.',
      },
      {
        question:
          "What's the difference between JoSAA rounds, CSAB special, and state counselling? Should I do all three?",
        answer:
          'Yes, usually. But the strategy for each is different. Mentors walk you through the timeline and how to keep options open across all three.',
      },
    ],
  },
];
...
export const howItWorksSteps = _override?.howItWorksSteps ?? [
  { step: '1', title: 'Share Details', text: 'Tell us your rank + target colleges.' },
  {
    step: '2',
    title: 'Get Matched',
    text: 'Get matched with a verified mentor from that exact college.',
  },
...
export const footerLinks = _override?.footerLinks ?? [
  { label: 'Instagram', href: 'https://www.instagram.com/askatyant.in/' },
  {
    ...
    title: 'All of you can join Atyant community',
  },
